...
${portals}
  ...
  return page({
    ...
    subtitleEn: 'Trust is a spectrum, not a verdict. A local, advisory trust-evaluation library &mdash; published at 0.2.0, and calibrated against nothing.',
    subtitleId: 'Trust itu spektrum, bukan putusan. Library evaluasi trust yang lokal dan bersifat saran &mdash; terbit di 0.2.0, dan belum dikalibrasi terhadap apa pun.',
    sections,
    body,
  });
}
