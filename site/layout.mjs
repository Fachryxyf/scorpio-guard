...
export const CSS = String.raw`
  ...
  * { box-sizing: border-box; }
  ...
  aside.toc ol { list-style: none; margin: 0 0 1.5rem; padding: 0; counter-reset: toc; }
  aside.toc li { counter-increment: toc; margin: 0; }
  aside.toc ol > li > a::before {
    content: counter(toc) ". "; color: var(--ink-3); font-variant-numeric: tabular-nums;
  }
  aside.toc a {
    display: block; padding: .22rem 0; font-size: .8125rem; line-height: 1.4;
